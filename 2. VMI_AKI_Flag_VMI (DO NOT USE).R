...
data = read.csv("/Users/chenxinlei/Library/Mobile Documents/com~apple~CloudDocs/Projects/AKI/Data/VMI/merged_data.csv")
names(data)


# Data for identifying the flag for AKI
data_AKI = data %>%
  select(PatientID, hour, death, day_alive, day_alive_cens800, RRT_30days, 
...
data_AKI_sub = data_AKI %>%
  select(PatientID, hour, AKI, FIRST_AKI_DATE, FIRST_AKI_STAGE, 
...
write.csv(data_AKI_sub, "/Users/chenxinlei/Library/Mobile Documents/com~apple~CloudDocs/Projects/AKI/Data/VMI/AKI_Flag_VMI_Data.csv", row.names = F)

data_with_AKI_flag = merge(data, data_AKI_sub, by = c("PatientID", "hour"))
data_with_AKI_flag = data_with_AKI_flag %>%
  arrange(PatientID, hour)
write.csv(data_with_AKI_flag, "/Users/chenxinlei/Library/Mobile Documents/com~apple~CloudDocs/Projects/AKI/Data/VMI/VMI_Complete_Data.csv", row.names = F)
